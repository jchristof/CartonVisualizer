...
public class InputSourceHands : InputSourceBase, ITargetingInputSource
{
    ...
    private void Awake() {
#if UNITY_WSA
        UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceDetected += InteractionManagerOnInteractionSourceDetected;
        UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceLost += InteractionManagerOnInteractionSourceLost;
        UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceUpdated += InteractionManagerOnInteractionSourceUpdated;

        UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourcePressed += InteractionManagerOnInteractionSourcePressed;
        UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceReleased += InteractionManagerOnInteractionSourceReleased;
...
#if UNITY_WSA
    private void InteractionManagerOnInteractionSourceDetected(InteractionSourceDetectedEventArgs interactionSourceDetectedEventArgs) {
        WSASourceEntered(interactionSourceDetectedEventArgs.state);
    }

    private void InteractionManagerOnInteractionSourceLost(InteractionSourceLostEventArgs interactionSourceLostEventArgs) {
        WSASourceLost(interactionSourceLostEventArgs.state);
    }

    private void InteractionManagerOnInteractionSourceUpdated(InteractionSourceUpdatedEventArgs interactionSourceUpdatedEventArgs) {
        WSASourceUpdate(interactionSourceUpdatedEventArgs.state);
    }

    private void InteractionManagerOnInteractionSourcePressed(InteractionSourcePressedEventArgs interactionSourcePressedEventArgs) {
        WSAFingerPressed(interactionSourcePressedEventArgs.state);
    }

    private void InteractionManagerOnInteractionSourceReleased(InteractionSourceReleasedEventArgs interactionSourceReleasedEventArgs) {
        WSAFingerReleased(interactionSourceReleasedEventArgs.state);
    }
#endif
